(function () {
  ...
  function injectStyles() {
    ...
    style.textContent =
      ...
      ".wa-chat-toggle{min-width:64px;height:56px;padding:0 18px;border:none;border-radius:999px;background:linear-gradient(135deg,#0f766e,#115e59);color:#fff;font-size:15px;font-weight:700;cursor:pointer;box-shadow:0 18px 40px rgba(15,118,110,.32);line-height:1.1}" +
      ...
      "@media (max-width:480px){.wa-chat-root{right:12px;left:12px;bottom:12px}.wa-chat-window{width:100%;height:72vh;right:0;bottom:76px}.wa-chat-toggle{min-width:0;width:auto;height:52px;padding:0 16px;font-size:14px}}";
